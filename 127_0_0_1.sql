...
--
-- Host: 127.0.0.1
-- Czas generowania: 04 Lis 2021, 18:33
...
INSERT INTO `employee` (`id`, `name`, `number`, `departament`, `salary`, `address`) VALUES
(27, 'Jan Kowalski', '890 355 428', 'Programmer JavaScript', 15000, 'Pogodna 15 Warszawa 01-128');
...
('root', '[{\"db\":\"employeesystem\",\"table\":\"employee\"},{\"db\":\"loginsystem\",\"table\":\"users\"},{\"db\":\"cms\",\"table\":\"posts\"},{\"db\":\"cms\",\"table\":\"categories\"},{\"db\":\"cms\",\"table\":\"category\"},{\"db\":\"loginapp\",\"table\":\"users\"}]');
...
('root', '2021-11-04 17:32:43', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"pl\"}');
